...
<script>
    $(document).ready(function() {
        ...
        // --- 1. GRAFIK BULANAN (LINE CHART) ---
        var ctxBulanan = document.getElementById('laporan-pendapatan-canvas').getContext('2d');
        ...
        // --- 2. GRAFIK PAKET TERLARIS 
        var ctxTerlaris = document.getElementById('paket-terlaris-canvas').getContext('2d');
        var chartTerlaris = new Chart(ctxTerlaris, {
            type: 'doughnut', 
            data: {
                // destinasi favorit
                labels: ['Bali', 'Jogja', 'Bromo', 'Bandung'],
                datasets: [{
                    // data dummy 
                    data: [60, 35, 45, 30], 
                    backgroundColor: ['#f56954', '#f39c12', '#00c0ef', '#79D482'],
                    borderWidth: 0
                }]
            },
            options: {
